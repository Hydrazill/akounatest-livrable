...
Commande.pre('save', async function(next) {
...
Commande.methods.changerStatut = function(nouveauStatut, commentaire = '') {
...
Commande.methods.calculerTotal = function() {
...
Commande.index({ clientId: 1, dateCommande: -1 });
Commande.index({ tableId: 1, dateCommande: -1 });
Commande.index({ statut: 1, dateCommande: -1 });
Commande.index({ numero: 1 });
